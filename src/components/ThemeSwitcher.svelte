...
<div
  class="-mr-4 lg:mr-[4.2rem] relative [&>button]:absolute [&>button]:flex [&>button]:justify-between [&>button]:w-[5.6rem] [&>button]:-mt-[0.6rem] [&>button]:items-center font-semibold text-xs w-[7rem] lg:text-base [&>button]:lg:w-[7rem]"
>
  {#if theme === 'light'}
    <button
